...
$.ajax({
    ...
    data: {Page: 1, StartDate: '2020.04.23', EndDate: '2021.04.23'},
...
for (let i = 1; i <= purchaseLastNum; i++) {
    ...
    $.ajax({
        ...
        data: {Page: i, StartDate: '2020.04.23', EndDate: '2021.04.23'},
...
<body><h1> 2020.04.23 ~ 2021.04.23 <br> 충전한 캐시는 어디로 갔을까? (총 ${numberFormat(
